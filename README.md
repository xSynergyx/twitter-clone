...
- [x] Added a bottom navigation bar

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/xSynergyx/twitter-clone/blob/master/TwitterPart2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

When I added the appbar, the recyclerview was pushed off the screen. I tried constraining the bottom of the recycler view but it didnt work. Finally I found a stackoverflow post that recommended I set the swiperefreshlayout height to 0dp.
